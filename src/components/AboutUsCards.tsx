const AboutUsCards = () => {
  return (
    <div className="d-flex flex-row justify-content-between about-card-wrapper padding-med flex-col-xs gap-1-xs">
      <div className="d-flex flex-row inherit-height  flex-1 ">
        ...
        <div className="d-flex flex-col flex-1 inherit-height padding-std">
          <h1 className="dark-blue-col">Mission Statement</h1>
          <p>
      ...
      <div className="d-flex flex-col inherit-height justify-content-between flex-1 gap-1-xs">
        <div className="d-flex flex-row inherit-height">
          <div className="green-bar primary-bg inherit-height"></div>
          <div className="d-flex flex-col flex-1 inherit-height padding-1">          
          <h1 className="dark-blue-col">Vision Statement</h1>
        ...
        <div className="d-flex flex-row inherit-height">
          <div className="green-bar primary-bg inherit-height"></div>
          <div className="d-flex flex-col flex-1 inherit-height padding-1">
          <h1 className="dark-blue-col">Target Market</h1>
